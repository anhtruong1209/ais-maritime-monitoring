      ...
      <DialogPrimitive.Portal>
        <DialogPrimitive.Popup
          className={cn(
            ...
            "fixed top-14 bottom-8 left-0 z-[2000] flex w-full translate-x-0 flex-col border-r border-border bg-popover text-popover-foreground shadow-2xl transition-transform duration-200 ease-in-out sm:w-[30rem] xl:w-[36rem]",
